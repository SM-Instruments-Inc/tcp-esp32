...
c.execute("SELECT TIME, ROUND(AVG(data)) FROM Gas_Datas WHERE sock = '58:BF:25:99:B4:D8' GROUP BY TIME")
...
c.execute("SELECT TIME, ROUND(AVG(data)) FROM Gas_Datas WHERE sock = '78:E3:6D:9:37:3C' GROUP BY TIME")
